...
//
//public class SideProjectCompetition implements Competition {
//	private String[] sideProjectAwardArr = {
//		"탈락","탈락","우수상","우수상","탈락","우수상","탈락","우수상","최우수상","최우수상","탈락","대상","탈락",
//	};
//	
//	@Override
//	public void participate(Player player) {
//		System.out.println("사이드 프로젝트 대회 참가!");
//		int awardIdx = (int)(Math.random() * (sideProjectAwardArr.length - 1));
//		
//		switch(sideProjectAwardArr[awardIdx]) {
//		case "탈락":
